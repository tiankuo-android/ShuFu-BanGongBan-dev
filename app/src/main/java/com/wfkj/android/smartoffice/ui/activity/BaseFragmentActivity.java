...
//    }
    ...
    protected GizWifiDeviceListener deviceListener = new GizWifiDeviceListener() {
        ...
        public void didExitProductionTesting(GizWifiErrorCode result, GizWifiDevice device) {
            BaseFragmentActivity.this.didExitProductionTesting(result, device);
        }

        @Override
        public void didReceiveData(GizWifiErrorCode result, GizWifiDevice device, ConcurrentHashMap<String, Object> dataMap, int sn) {
            BaseFragmentActivity.this.didReceiveData(result, device, dataMap, sn);
        }

        @Override
        public void didSetSubscribe(GizWifiErrorCode result, GizWifiDevice device, boolean isSubscribed) {
            BaseFragmentActivity.this.didSetSubscribe(result, device, isSubscribed);
        }

        @Override
        public void didGetHardwareInfo(GizWifiErrorCode result, GizWifiDevice device, ConcurrentHashMap<String, String> hardwareInfo) {
            BaseFragmentActivity.this.didGetHardwareInfo(result, device, hardwareInfo);
        }

        @Override
        public void didUpdateNetStatus(GizWifiDevice device, GizWifiDeviceNetStatus netStatus) {
            BaseFragmentActivity.this.didUpdateNetStatus(device, netStatus);
        }

        @Override
        public void didSetCustomInfo(GizWifiErrorCode result, GizWifiDevice device) {
            BaseFragmentActivity.this.didSetCustomInfo(result, device);
        }
    ...
    private GizWifiSDKListener sdkListener = new GizWifiSDKListener() {
        ...
        public void didGetCurrentCloudService(GizWifiErrorCode result, ConcurrentHashMap<String, String> cloudServiceInfo) {
            BaseFragmentActivity.this.didGetCurrentCloudService(result, cloudServiceInfo);
        }

        @Override
        public void didGetUserInfo(GizWifiErrorCode result, GizUserInfo userInfo) {
            BaseFragmentActivity.this.didGetUserInfo(result, userInfo);
        }

        @Override
        public void didDisableLAN(GizWifiErrorCode result) {
            BaseFragmentActivity.this.didDisableLAN(result);
        }

        @Override
        public void didChannelIDBind(GizWifiErrorCode result) {
            BaseFragmentActivity.this.didChannelIDBind(result);
        }

        @Override
        public void didChannelIDUnBind(GizWifiErrorCode result) {
            BaseFragmentActivity.this.didChannelIDUnBind(result);
        }

        @Override
        public void didCreateScheduler(GizWifiErrorCode result, String sid) {
            BaseFragmentActivity.this.didCreateScheduler(result, sid);
        }

        @Override
        public void didDeleteScheduler(GizWifiErrorCode result) {
            BaseFragmentActivity.this.didDeleteScheduler(result);
        }

//        @Override
//        public void didGetSchedulers(GizWifiErrorCode result, List<GizSchedulerInfo> scheduleTaskList) {
//            BaseFragmentActivity.this.didGetSchedulers(result, scheduleTaskList);
//        }
        ...
        public void didGetSchedulerStatus(GizWifiErrorCode result, String sid, String datetime, GizScheduleStatus status, ConcurrentHashMap<String, Boolean> statusDetail) {
            BaseFragmentActivity.this.didGetSchedulerStatus(result, sid, datetime, status, statusDetail);
        }

        @Override
        public void didBindDevice(GizWifiErrorCode result, String did) {
            BaseFragmentActivity.this.didBindDevice(result, did);
        }

        @Override
        public void didUnbindDevice(GizWifiErrorCode result, String did) {
            BaseFragmentActivity.this.didUnbindDevice(result, did);
        }

        @Override
        public void didChangeUserInfo(GizWifiErrorCode result) {
            BaseFragmentActivity.this.didChangeUserInfo(result);
        }

        @Override
        public void didTransAnonymousUser(GizWifiErrorCode result) {
            BaseFragmentActivity.this.didTransAnonymousUser(result);
        }

        @Override
        public void didUpdateProduct(GizWifiErrorCode result, String productKey, String productUI) {
            BaseFragmentActivity.this.didUpdateProduct(result, productKey, productUI);
        }

        @Override
        public void didDiscovered(GizWifiErrorCode result, List<GizWifiDevice> deviceList) {
            BaseFragmentActivity.this.didDiscovered(result, deviceList);
        }


        @Override
        public void didUserLogin(GizWifiErrorCode result, String uid, String token) {
            BaseFragmentActivity.this.didUserLogin(result, uid, token);
        }

        @Override
        public void didNotifyEvent(GizEventType eventType, Object eventSource, GizWifiErrorCode eventID, String eventMessage) {
            BaseFragmentActivity.this.didNotifyEvent(eventType, eventSource, eventID, eventMessage);
        }

        @Override
        public void didSetDeviceOnboarding(GizWifiErrorCode result, String mac, String did, String productKey) {
            BaseFragmentActivity.this.didSetDeviceOnboarding(result, mac, did, productKey);
        }

        @Override
        public void didGetSSIDList(GizWifiErrorCode result, List<GizWifiSSID> ssidInfoList) {
            BaseFragmentActivity.this.didGetSSIDList(result, ssidInfoList);
        }

        @Override
        public void didGetCaptchaCode(GizWifiErrorCode result, String token, String captchaId, String captchaURL) {
            BaseFragmentActivity.this.didGetCaptchaCode(result, token, captchaId, captchaURL);
        }

        @Override
        public void didVerifyPhoneSMSCode(GizWifiErrorCode result) {
            BaseFragmentActivity.this.didVerifyPhoneSMSCode(result);
        }

        @Override
        public void didRegisterUser(GizWifiErrorCode result, String uid, String token) {
            BaseFragmentActivity.this.didRegisterUser(result, uid, token);
        }

        @Override
        public void didChangeUserPassword(GizWifiErrorCode result) {
            BaseFragmentActivity.this.didChangeUserPassword(result);
        }

        @Override
        public void didGetGroups(GizWifiErrorCode result, List<GizWifiGroup> groupList) {
            BaseFragmentActivity.this.didGetGroups(result, groupList);
        }
